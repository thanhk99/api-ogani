...
// @GetMapping("/price")
// @Operation(summary = "Lấy ra danh sách 8 sản phẩm có giá từ thấp nhất đến
// cao")
...
// public ResponseEntity<List<Product>> getListRelatedProduct(@PathVariable long
// id) {
...
// public ResponseEntity<List<Product>> getListProductByCategory(@PathVariable
// long id) {
...
// @GetMapping("/range")
// @Operation(summary = "Lấy ra danh sách sản phẩm ở các mức giá từ min đến
// max")
// public ResponseEntity<List<Product>>
// getListProductByPriceRange(@RequestParam("id") long id,
...
// public ResponseEntity<List<Product>> searchProduct(@RequestParam("keyword")
// String keyword) {
